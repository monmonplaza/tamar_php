...
function tamar__assets() {
    wp_enqueue_style('tamar_style', get_template_directory_uri() . '/css/main.min.css',   microtime());
    wp_enqueue_style('tamar_icon', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css',   microtime());
    
    wp_enqueue_style('tamar_mobile', get_template_directory_uri() . '/css/mobile.min.css',  microtime());
